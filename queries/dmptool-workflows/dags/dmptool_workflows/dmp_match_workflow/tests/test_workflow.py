            ...
            self.assert_dag_structure(
                {
                    ...
                    "fetch_dmps": [
                        ...
                        "create_dmp_matches.update_content_table",
                        "create_dmp_matches.update_embeddings",
                    ...
                    "create_dmp_matches.match_intermediate": ["create_dmp_matches.update_content_table"],
                    "create_dmp_matches.update_content_table": ["create_dmp_matches.update_embeddings"],
                    "create_dmp_matches.update_embeddings": ["create_dmp_matches.match_vector_search"],
