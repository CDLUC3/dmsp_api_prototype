...
FROM datacite.works AS dw, UNNEST(dw.institutions) WITH ORDINALITY AS item(inst, pos)
LEFT JOIN ror.index ON dw.affiliation_identifier = ror.index.identifier
GROUP BY dw.doi;
