# frozen_string_literal: true
 ...
 if ARGV.length >= 3
   ...
   @function_name = 'GetDownloadsDmps'
   ...
   @cf_params = %w[S3FileExchangeBucketId DynamoTableName EventBusArn DeadLetterQueueArn]
   ...
   @ssm_params = %w[DomainName DMPToolDatabaseLayerArn DMPToolLoggerLayerArn]
   #
   #
