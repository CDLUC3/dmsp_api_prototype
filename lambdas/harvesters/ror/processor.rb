  ...
  class RorProcessor
    ...
    class << self
      def process(event:, context:)
        ...
        logger&.info(message: "Created/Updated #{rec_count} in the Dynamo ExternalData table.")
        return { statusCode: 200, body: "Success - Created/Updated #{rec_count} entries in the Dynamo ExternalData table" }
